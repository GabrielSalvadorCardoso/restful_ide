...
urlpatterns = [
    ...
    path('edif-agropec-ext-vegetal-pesca/<int:pk>', EdifAgropecExtVegetalPescaDetail.as_view(),
         name='EdifAgropecExtVegetalPesca_detail'),
    path('edif-agropec-ext-vegetal-pesca', EdifAgropecExtVegetalPescaList.as_view(),
         name='EdifAgropecExtVegetalPesca_list'),
    ...
    path('est-gerad-energia-eletrica/<int:pk>', EstGeradEnergiaEletricaDetail.as_view(),
         name='EstGeradEnergiaEletrica_detail'),
    ...
    path('terreno-sujeito-inundacao/<int:pk>', TerrenoSujeitoInundacaoDetail.as_view(),
         name='TerrenoSujeitoInundacao_detail'),
    ...
    path('outros-limites-oficiais/<int:pk>', OutrosLimitesOficiaisDetail.as_view(),
         name='OutrosLimitesOficiais_detail'),
    ...
    path('unidade-conservacao-nao-snuc/<int:pk>', UnidadeConservacaoNaoSnucDetail.as_view(),
         name='UnidadeConservacaoNaoSnuc_detail'),
    ...
    path('unidade-protecao-integral/<int:pk>', UnidadeProtecaoIntegralDetail.as_view(),
         name='UnidadeProtecaoIntegral_detail'),
    path('unidade-protecao-integral', UnidadeProtecaoIntegralList.as_view(), name='UnidadeProtecaoIntegral_list'),

    path('unidade-uso-sustentavel/<int:pk>', UnidadeUsoSustentavelDetail.as_view(),
         name='UnidadeUsoSustentavel_detail'),
    path('unidade-uso-sustentavel', UnidadeUsoSustentavelList.as_view(), name='UnidadeUsoSustentavel_list'),

    path('aglomerado-rural-isolado/<int:pk>', AglomeradoRuralIsoladoDetail.as_view(),
    ...
    path('elemento-fisiografico-natural-l/<int:pk>', ElementoFisiograficoNaturalLDetail.as_view(),
         name='ElementoFisiograficoNaturalL_detail'),
    path('elemento-fisiografico-natural-l', ElementoFisiograficoNaturalLList.as_view(),
         name='ElementoFisiograficoNaturalL_list'),

    path('elemento-fisiografico-natural-p/<int:pk>', ElementoFisiograficoNaturalPDetail.as_view(),
         name='ElementoFisiograficoNaturalP_detail'),
    path('elemento-fisiografico-natural-p', ElementoFisiograficoNaturalPList.as_view(),
         name='ElementoFisiograficoNaturalP_list'),

    path('pico/<int:pk>', PicoDetail.as_view(), name='Pico_detail'),
    path('pico', PicoList.as_view(), name='Pico_list'),

    path('ponto-cotado-altimetrico/<int:pk>', PontoCotadoAltimetricoDetail.as_view(),
         name='PontoCotadoAltimetrico_detail'),
    path('ponto-cotado-altimetrico', PontoCotadoAltimetricoList.as_view(), name='PontoCotadoAltimetrico_list'),

    path('ponto-cotado-batimetrico/<int:pk>', PontoCotadoBatimetricoDetail.as_view(),
         name='PontoCotadoBatimetrico_detail'),
    ...
    path('edif-constr-aeroportuaria/<int:pk>', EdifConstrAeroportuariaDetail.as_view(),
         name='EdifConstrAeroportuaria_detail'),
    ...
    # path("icons/marker-icon.png", IconDetail.as_view(), name="Icon_detail")
]
